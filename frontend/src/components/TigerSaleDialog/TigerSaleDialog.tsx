...
interface TigerSaleDialogProps {
...
export const TigerSaleDialog = ({
  isOpen,
  onClose,
  tigerData,
  name,
  offer,
}: TigerSaleDialogProps) => {
  ...
  const giveApproval = useFunction(tigerCore, "setApprovalForAll");
  const isApprovedForAll = useFetch<boolean>(tigerCore, "isApprovedForAll", {
      ...
      <Dialog open={isOpen} onClose={onClose}>
        ...
        <DialogContent>
          <DialogContentText>
            ...
            approval to the marketplace to transfer your tigers. This needs to
            be done only once.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
